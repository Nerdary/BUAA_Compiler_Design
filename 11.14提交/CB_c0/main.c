...
void err(int index){
	switch(index){
		case(0):	printf("an uknown error occured.\n");								break;
		case(1):	printf("error while transforming string into integer.(USINTSY)\n");	break;
		case(2):	printf("illegal charactor while dealing string.(STRINGSY)\n");		break;
		case(3):	printf("more than one charactor in ''.(ACHARSY)\n");				break;
		case(4):	printf("illegal charactor while dealing single char.(ACHARSY)\n");	break;
